export const REACT_BACKEND_URL=process.env.REACT_APP_BACKEND_URL || 'http://localhost:3000/shore-birdie';
...
export const REACT_BACKEND_IP=process.env.REACT_APP_BACKEND_ROUTE || '';
